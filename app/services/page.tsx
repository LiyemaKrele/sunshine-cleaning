    ...
    <main className="bg-blue-50 min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="h-48 md:h-56 w-full bg-blue-100 relative">
              <Image
          ...
          >
            ...
            <div className="p-6 text-center">
              ...
              <p className="text-blue-500">
                Perfect for relocations. We ensure your space is spotless before
                moving in or after moving out.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-6 text-center">
              ...
              <p className="text-blue-500">
                Professional cleaning services to maintain a clean, productive
